...
{{--																	<!--begin::Svg Icon | path:/metronic/media/svg/icons/Home/Library.svg-->--}}
...
{{--															</span>--}}
{{--                                            <span--}}
{{--                                                class="nav-text font-size-lg py-2 font-weight-bold text-center">SAAS Application</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!--end::Item-->--}}
{{--                                    <!--begin::Item-->--}}
...
{{--															<span class="nav-icon py-2 w-auto">--}}
{{--																<span class="svg-icon svg-icon-3x">--}}
{{--																	<!--begin::Svg Icon | path:/metronic/media/svg/icons/Layout/Layout-4-blocks.svg-->--}}
{{--																	<svg xmlns="http://www.w3.org/2000/svg"--}}
{{--                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                                                         width="24px" height="24px" viewBox="0 0 24 24"--}}
{{--                                                                         version="1.1">--}}
...
{{--															</span>--}}
{{--                                            <span--}}
{{--                                                class="nav-text font-size-lg py-2 font-weight-bolder text-center">Main Categories</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!--end::Item-->--}}
{{--                                    <!--begin::Item-->--}}
...
{{--															<span class="nav-icon py-2 w-auto">--}}
{{--																<span class="svg-icon svg-icon-3x">--}}
{{--																	<!--begin::Svg Icon | path:/metronic/media/svg/icons/Media/Movie-Lane2.svg-->--}}
{{--																	<svg xmlns="http://www.w3.org/2000/svg"--}}
{{--                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                                                         width="24px" height="24px" viewBox="0 0 24 24"--}}
{{--                                                                         version="1.1">--}}
...
{{--															</span>--}}
{{--                                            <span--}}
{{--                                                class="nav-text font-size-lg py-2 font-weight-bolder text-center">Video Tutorials</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!--end::Item-->--}}
{{--                                    <!--begin::Item-->--}}
...
{{--															<span class="nav-icon py-2 w-auto">--}}
{{--																<span class="svg-icon svg-icon-3x">--}}
{{--																	<!--begin::Svg Icon | path:/metronic/media/svg/icons/Media/Equalizer.svg-->--}}
{{--																	<svg xmlns="http://www.w3.org/2000/svg"--}}
{{--                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                                                         width="24px" height="24px" viewBox="0 0 24 24"--}}
{{--                                                                         version="1.1">--}}
...
{{--															</span>--}}
{{--                                            <span--}}
{{--                                                class="nav-text font-size-lg py-2 font-weight-bolder text-center">Sales Statistics</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!--end::Item-->--}}
{{--                                    <!--begin::Item-->--}}
...
{{--															<span class="nav-icon py-2 w-auto">--}}
{{--																<span class="svg-icon svg-icon-3x">--}}
{{--																	<!--begin::Svg Icon | path:/metronic/media/svg/icons/General/Shield-check.svg-->--}}
{{--																	<svg xmlns="http://www.w3.org/2000/svg"--}}
{{--                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                                                         width="24px" height="24px" viewBox="0 0 24 24"--}}
{{--                                                                         version="1.1">--}}
...
{{--															</span>--}}
{{--                                            <span--}}
{{--                                                class="nav-text font-size-lg py-2 font-weight-bolder text-center">System Security</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!--end::Item-->--}}
{{--                                    <!--begin::Item-->--}}
...
{{--															<span class="nav-icon py-2 w-auto">--}}
{{--																<span class="svg-icon svg-icon-3x">--}}
{{--																	<!--begin::Svg Icon | path:/metronic/media/svg/icons/Communication/Group.svg-->--}}
{{--																	<svg xmlns="http://www.w3.org/2000/svg"--}}
{{--                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"--}}
{{--                                                                         width="24px" height="24px" viewBox="0 0 24 24"--}}
{{--                                                                         version="1.1">--}}
...
{{--															</span>--}}
{{--                                            <span--}}
{{--                                                class="nav-text font-size-lg py-2 font-weight-bolder text-center">Customer Support</span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <!--end::Item-->--}}
{{--                                </ul>--}}
...
{{--															<!--begin::Svg Icon | path:/metronic/media/svg/icons/Navigation/Arrow-right.svg-->--}}
{{--															<svg xmlns="http://www.w3.org/2000/svg"--}}
