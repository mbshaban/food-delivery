    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="index-2.html"><img class="brand-logo"
            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#"><i class="ft-align-left"></i> Multi level menu</a>
                                                <ul>
                                                    ...
                                                    <li><a class="dropdown-item" href="#"><i
                                                                class="fa fa-envelope-o"></i> Second level, fourth link</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a class="dropdown-item"
                                                   href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/ltr/vertical-menu-template/layout-2-columns.html"><i
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                                ...
                                class="flag-icon flag-icon-af"></i><span>AFghanistan</span><span
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                                ...
                                <img src="../../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span
                                class="user-name">ali</span></a>
