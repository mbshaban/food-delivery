                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{url('sellers/products/insert')}}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button title="بروز رسانی"
                                                                onclick="window.location='{{ url('sellers/products/edit/'.$product->id) }}'"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <h4 align="center" style="margin: 0"> آیا با حذف این محصول موافق هستید؟</h4>
                                                            </div>
