      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="index-2.html"><img class="brand-logo" alt="robust admin logo" src="../../../app-assets/images/logo/logo-dark-sm.png">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              <li class=" nav-item"><a href="index-2.html"><i class="icon-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span><span class="badge badge badge-info badge-pill float-right mr-2">5</span></a>
                <ul class="menu-content">
                  <li class="active"><a class="menu-item" href="dashboard-analytics.html" data-i18n="nav.dash.analytics">Analytics</a>
                  </li>
              ...
              <li class=" nav-item"><a href="#"><i class="icon-share"></i><span class="menu-title" data-i18n="nav.vertical_nav.main">Vertical Nav</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="#" data-i18n="nav.vertical_nav.vertical_navigation_types.main">Navigation Types</a>
                    <ul class="menu-content">
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/vertical-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_menu">Vertical Menu</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/vertical-multi-level-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_mmenu">Vertical MMenu</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/vertical-overlay-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_overlay">Vertical Overlay</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/vertical-compact-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_compact">Vertical Compact</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/vertical-content-menu-template" data-i18n="nav.vertical_nav.vertical_navigation_types.vertical_content">Vertical Content</a>
                      </li>
                    </ul>
                  </li>
              ...
              <li class=" nav-item"><a href="#"><i class="icon-equalizer"></i><span class="menu-title" data-i18n="nav.horz_nav.main">Horizontal Nav</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="#" data-i18n="nav.horz_nav.horizontal_navigation_types.main">Navigation Types</a>
                    <ul class="menu-content">
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/horizontal-menu-template" data-i18n="nav.horz_nav.horizontal_navigation_types.horizontal_left_icon_navigation">Left Icon Navigation</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/html/rtl/horizontal-top-icon-menu-template" data-i18n="nav.horz_nav.horizontal_navigation_types.horizontal_top_icon_navigation">Top Icon Navigation</a>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <li class=" nav-item"><a href="#"><i class="icon-bulb"></i><span class="menu-title" data-i18n="nav.starter_kit.main">Starter kit</span></a>
                <ul class="menu-content">
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-1-column.html" data-i18n="nav.starter_kit.1_column">1 column</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-2-columns.html" data-i18n="nav.starter_kit.2_columns">2 columns</a>
                  </li>
                  <li><a class="menu-item" href="#" data-i18n="nav.starter_kit.3_columns_detached.main">Content Det. Sidebar</a>
                    <ul class="menu-content">
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-content-detached-left-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_left_sidebar">Detached left sidebar</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-content-detached-left-sticky-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_left_sidebar">Detached sticky left sidebar</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-content-detached-right-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_right_sidebar">Detached right sidebar</a>
                      </li>
                      <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-content-detached-right-sticky-sidebar.html" data-i18n="nav.starter_kit.3_columns_detached.3_columns_detached_sticky_right_sidebar">Detached sticky right sidebar</a>
                      </li>
                    </ul>
                  </li>
                  <li class="navigation-divider"></li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-fixed-navbar.html" data-i18n="nav.starter_kit.fixed_navbar">Fixed navbar</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-fixed-navigation.html" data-i18n="nav.starter_kit.fixed_navigation">Fixed navigation</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-fixed-navbar-navigation.html" data-i18n="nav.starter_kit.fixed_navbar_navigation">Fixed navbar &amp; navigation</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-fixed-navbar-footer.html" data-i18n="nav.starter_kit.fixed_navbar_footer">Fixed navbar &amp; footer</a>
                  </li>
                  <li class="navigation-divider"></li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-fixed.html" data-i18n="nav.starter_kit.fixed_layout">Fixed layout</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-boxed.html" data-i18n="nav.starter_kit.boxed_layout">Boxed layout</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-static.html" data-i18n="nav.starter_kit.static_layout">Static layout</a>
                  </li>
                  <li class="navigation-divider"></li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-light.html" data-i18n="nav.starter_kit.light_layout">Light layout</a>
                  </li>
                  <li><a class="menu-item" href="https://pixinvent.com/bootstrap-admin-template/robust/starter-kit/rtl/vertical-content-menu-template/layout-dark.html" data-i18n="nav.starter_kit.dark_layout">Dark layout</a>
                  </li>
                </ul>
              </li>
...
<!-- Mirrored from pixinvent.com/bootstrap-admin-template/robust/html/rtl/vertical-content-menu-template/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Feb 2021 08:52:16 GMT -->
</html>
